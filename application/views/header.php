<!DOCTYPE html>
<html class="no-js beige" lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta
      name="viewport"
    ...
    <link
      ...
      sizes="60x60"
      href="<?=base_url()?>assets/favicons/apple-touch-icon.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="32x32"
      href="<?=base_url()?>assets/favicons/favicon-32x32.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="<?=base_url()?>assets/favicons/favicon-16x16.png"
    />
    <meta name="msapplication-TileColor" content="#E6DA89" />
    <meta name="theme-color" content="#E6DA89" />
    <link rel="stylesheet" href="<?=base_url()?>assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?=base_url()?>assets/css/main.css" />
    <link rel="stylesheet" href="<?=base_url()?>assets/css/theme-dark.css" />
    <title>Eustyle Interiors</title>
    <style>
      html {
      ...
      .works-section {
        ...
        background: url('<?=base_url()?>assets/images/footer-bg-dark.jpg') center;
      }
  ...
  <body class="webpage webpage--beige">
    <div style="display: none">
      ...
      >
        ...
        <symbol id="heart-filled" viewBox="0 0 64 64">
          <path
            d="M30.6 59c.8.8 2.1.8 2.8 0l25.8-26.1c3.2-3.2 4.8-7.5 4.8-11.7s-1.6-8.8-5.1-12c-6.4-6.4-17.3-6.4-23.7 0L32 12.7l-3.5-3.5c-3.4-3.2-7.7-4.8-12-4.8S8 6 4.8 9.2c-6.4 6.4-6.4 17.3 0 23.7L30.6 59z"
          />
        </symbol>
        ...
        <symbol id="package" viewBox="0 0 17 17">
          <path
            d="M8.517-.035L0 3.186v10.693l8.5 3.188 8.5-3.188V3.187L8.517-.035zm6.567 3.563l-2.586.97-6.557-2.489 2.575-.974 6.568 2.493zM8.5 5.997L1.919 3.529l2.609-.986 6.551 2.487-2.579.967zM1 4.253l7 2.625v8.932l-7-2.625V4.253zM9 15.81V6.878l7-2.625v8.932L9 15.81z"
          />
        </symbol>
        ...
        <symbol id="play" viewBox="0 0 64 64">
          <path
            d="M56.6 27.9L12.8.7C11.2-.1 9.3-.4 8 .7c-1.6.5-2.7 2.1-2.7 4v54.7c0 1.6 1.1 3.2 2.4 4 .8.3 1.6.5 2.4.5s1.9-.3 2.7-.8L56.6 36c1.3-.8 2.1-2.4 2.1-4s-.8-3.3-2.1-4.1zm-46 30.2V5.8L52.8 32 10.6 58.1z"
          />
        </symbol>
        <symbol id="rss" viewBox="0 0 448 448">
          <circle cx="64" cy="384" r="64" />
          <path
            d="M0 149.344v85.344c117.632 0 213.344 95.68 213.344 213.312h85.312c0-164.672-133.984-298.656-298.656-298.656z"
          />
          <path
        ...
        <div class="header__inner">
          ...
          <a href="#" class="header__logo logo">
            <span class="logo__image">
              <img src="<?=base_url()?>assets/images/eustyle_logo.png" alt="" height="70" />
            </span>
          </a>
          <!-- Header menu-->
          <nav class="header__nav navigation">
            <ul class="navigation__list">
              ...
              <li class="navigation__item">
                <a class="navigation__link" href="#works">Works</a>
              </li>
              <li class="navigation__item">
          ...
          <ul class="header__lang-switcher lang-switcher lang-switcher--white">
            <li class="lang-switcher__item">
              <a class="social__link" href="<?=$web->fblink?>">
                <svg
                  width="18"
                  height="18"
                  fill="white"
            ...
            <li class="lang-switcher__item">
              <a class="social__link" href="<?=$web->instalink?>">
                <svg
                  width="18"
                  height="18"
                  fill="white"
      ...
      <section class="menu">
        <div class="menu__inner">
          ...
          <ul
            class="
              menu__lang-switcher
              lang-switcher lang-switcher--upper lang-switcher--menu
            "
          >
            <li class="lang-switcher__item">
              <a class="lang-switcher__link lang-switcher__link--current"
                >&nbsp;</a
              >
            </li>
          </ul>
          <div class="menu__wrapper">
            <ul class="menu__list">
              <li class="menu__item menu__item--current">
                <a class="menu__link mobile_nav_link" href="#">Home</a>
              </li>
              <li class="menu__item">
                <a class="menu__link mobile_nav_link" href="#about">About</a>
              </li>
              <li class="menu__item">
                <a class="menu__link mobile_nav_link" href="#services"
                  >Services</a
                >
              </li>
              <li class="menu__item">
                <a class="menu__link mobile_nav_link" href="#works">Works</a>
              </li>
              <li class="menu__item">
                <a class="menu__link mobile_nav_link" href="#contact"
                  >Contact</a
                >
              </li>
            </ul>
          ...
          <div class="menu__bottom">
            <div class="menu__copy">
              ...
              <br />Developed by <span>DigiKraft Social</span>
            </div>
            <!-- Social-->
